      ...
      <div className="relative h-[60vh] min-h-[500px] bg-gray-100">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-noto-serif font-bold mb-6 leading-tight">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="/fakultet"
                className="inline-flex items-center px-8 py-3 text-white font-gt-america font-medium text-lg hover:opacity-90 transition-colors duration-200"
              ...
              <a
                ...
                className="inline-flex items-center px-8 py-3 border-2 border-white text-white font-gt-america font-medium text-lg hover:bg-white hover:text-gray-900 transition-colors duration-200"
              >
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-noto-serif font-semibold text-gray-900 mb-3">
